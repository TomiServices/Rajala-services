...
firebase functions:config:set email.from="Rajala Services <noreply@fixnero.fi>"
```
...
```json
{
  "email": {
    ...
    "from": "Rajala Services <noreply@fixnero.fi>"
  }
}
```
...
firebase functions:config:set \
  ...
  email.from="Rajala Services <noreply@fixnero.fi>"
...
- [ ] reCAPTCHA domains include: `fixnero.fi`, `www.fixnero.fi`
